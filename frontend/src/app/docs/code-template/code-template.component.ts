...
init();`;
  ...
  wrapCommonJS(code: any) {
    ...
    if (code.codeTemplate) {
      ...
      const importText = `<script src="https://b1tpool.org/mempool.js"></script>`;
...
yarn add @mempool/mempool.js`;
  ...
  wrapPythonTemplate(code: any) {
    return ( ( this.network === 'testnet' ) ? ( code.codeTemplate.python.replace( 'wss://b1tpool.org/api/v1/ws', 'wss://b1tpool.org/' + this.network + '/api/v1/ws' ) ) : code.codeTemplate.python );
  }
